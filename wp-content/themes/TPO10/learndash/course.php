<?php
	...
	*/
	...
	if($logged_in) {
		...
		?>
			<span id='learndash_course_status'>
				<strong><?php _e('Course Status:', 'learndash') ?></strong> <?php echo 'Not enrolled'; ?>
				<br>
			</span><br>
		<?php
		} else { ?>
	...
	if ( !$has_access ) {
		...
		//echo '<a  id="btn-join">'.__( 'Take this Course', 'learndash' ).'</a>';
		
		echo '<form class="postLink" action="/scripts/enrolonly.php" method="post">
    <input type="hidden" name="user_id" value="'.$user_id.'"/>
    <input type="hidden" name="course_id" value="'.$course_id.'"/>
    <input type="hidden" name="link_url" value="'.get_permalink($course_id).'"/>
    <input class="btn-join"  type="submit" value="Take this Course"/>
</form>';
