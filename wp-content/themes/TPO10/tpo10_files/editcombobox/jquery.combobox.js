...
(function () {
    ...
    jQuery.fn.editcombobox = function (selectOptions) {
    
        return this.each(function () {
            var newCombobox = new Combobox(this, selectOptions);
            jQuery.editcombobox.instances.push(newCombobox);
        });
    ...
    var ComboboxSelector = function (combobox) {
        ...
        this.selectorElement = jQuery(
            ...
            '></div>'
        ).insertAfter(this.editcombobox.textInputElement);
        ...
        this.keypressHandler = function (e) {
            if (e.keyCode == Combobox.keys.DOWNARROW) {
                ...
                thisSelector.hide();
                thisSelector.editcombobox.focus();
            } else if (e.keyCode == Combobox.keys.ENTER) {
                if(thisSelector.selectedIndex !== -1){
                    e.preventDefault();
                }
                thisSelector.editcombobox.setValue(thisSelector.getSelectedValue());
                thisSelector.editcombobox.focus();
                thisSelector.hide();
    ...
    ComboboxSelector.prototype = {
        ...
        buildSelectOptionList : function (startingLetters) {
            ...
            this.selectorElement.find('li').click(function (e) {
                thisSelector.hide();
                thisSelector.editcombobox.setValue(this.innerHTML);
                thisSelector.editcombobox.focus();
            });
        ...
        getSelectedValue : function () {
            if(this.selectedIndex !== -1){
                ...
                return this.editcombobox.textInputElement.val();
            }
        }
