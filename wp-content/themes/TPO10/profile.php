...
<div class="page-header navbar navbar-fixed-top">
	...
	<div class="page-header-inner">
		...
		<div class="page-logo">
			<a href="index.html">
			<img src="http://www.tpo10.com/wp-content/themes/tpo10/assets/img/logo-small.png" alt="logo" class="logo-default"/>
			</a>
			...
			<ul class="page-sidebar-menu " data-auto-scroll="true" data-slide-speed="200">
				...
				<li>
					...
					<ul class="sub-menu">
						...
						<li>
							<a href="/saveddocuments">
							<i class="icon-basket"></i>
							Saved</a>
						</li>
						<li>
							<a href="/completeddocuments">
							<i class="icon-tag"></i>
							Completed</a>
						</li>
					</ul>
				...
				<li>
					...
					<ul class="sub-menu">
						...
						<li>
							<a href="/trainingcalendar">
							<i class="icon-basket"></i>
							My Training Calendar</a>
						</li>
					</ul>
				</li>	
				<li>
