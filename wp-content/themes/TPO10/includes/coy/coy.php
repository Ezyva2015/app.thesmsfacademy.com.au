...
function corp_post_Data($item, $order_id, $deedVersion, $constitutionVersion, $billingArray, $billingName, $billingCompany, $billing_phone, $product_id, $adviserEmail, $userID, $orderDate) {
		...
		$d1Address = array(
			...
			'suburbName' => $item['item_meta']['d1AddressSuburbName'][0],
		...
		$d2Address = array(
			...
			'suburbName' => $item['item_meta']['d2AddressSuburbName'][0],
		...
		$d3Address = array(
			...
			'suburbName' => $item['item_meta']['d3AddressSuburbName'][0],
		...
		//D4 Address
			...
			'suburbName' => $item['item_meta']['d4AddressSuburbName'][0],
		...
		$sh1Address = array(
			...
			'suburbName' => $item['item_meta']['sh1AddressSuburbName'][0],
		...
		$sh2Address = array(
			...
			'suburbName' => $item['item_meta']['sh2AddressSuburbName'][0],
		...
		//SH3 Address
			...
			'suburbName' => $item['item_meta']['sh3AddressSuburbName'][0],
		...
		$sh4Address = array(
			...
			'suburbName' => $item['item_meta']['sh4AddressSuburbName'][0],
		...
		$applicantAddress = array(
			...
			'suburbName' => $item['item_meta']['applicantAddressSuburbName'][0],
		...
		//Director 1 Details
		$d1BornInAustralia = $item['item_meta']['d1BornInAustralia'][0];
		
		if($d1BornInAustralia == 'Yes'){
			$d1TownOfBirth = $item['item_meta']['d1TownOfBirth'][0];
			$d1StateOfBirth = $item['item_meta']['d1StateOfBirth'][0];
			$d1CountryOfBirth = NULL;
		}
		else {
			$d1TownOfBirth  = NULL;
			$d1StateOfBirth = NULL;
		...
		//Director 2 Details
		$d2BornInAustralia = $item['item_meta']['d2BornInAustralia'][0];
		
		if($d2BornInAustralia == 'Yes'){
			$d2TownOfBirth = $item['item_meta']['d2TownOfBirth'][0];
			$d2StateOfBirth = $item['item_meta']['d2StateOfBirth'][0];
			$d2CountryOfBirth = NULL;
		}
		else {
			$d2TownOfBirth = NULL;
			$d2StateOfBirth = NULL;
		...
		//Director 3 Details
		$d3BornInAustralia = $item['item_meta']['d3BornInAustralia'][0];
		
		if($d3BornInAustralia == 'Yes'){
			$d3TownOfBirth = $item['item_meta']['d3TownOfBirth'][0];
			$d3StateOfBirth = $item['item_meta']['d3StateOfBirth'][0];
			$d3CountryOfBirth = NULL;
		}
		else {
			$d3TownOfBirth = NULL;
			$d3StateOfBirth = NULL;
		...
		//Director 4 Details
		$d4BornInAustralia = $item['item_meta']['d4BornInAustralia'][0];
		
		if($d4BornInAustralia == 'Yes'){
			$d4TownOfBirth = $item['item_meta']['d4TownOfBirth'][0];
			$d4StateOfBirth = $item['item_meta']['d4StateOfBirth'][0];
			$d4CountryOfBirth = NULL;
		}
		else {
			$d4TownOfBirth = NULL;
			$d4StateOfBirth = NULL;
		...
		$applicantDetails = array(
			'memberNamePrefix' => $item['item_meta']['applicantNamePrefix'][0],
