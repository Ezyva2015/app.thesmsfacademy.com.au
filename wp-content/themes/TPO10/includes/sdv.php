...
function sdv_indiv_post_Data($item, $order_id, $deedVersion, $constitutionVersion, $billingArray, $billingName, $billingCompany, $billing_phone, $product_id, $adviserEmail, $userID, $orderDate) {
		...
		$estVariationClause = $item['item_meta']['estDeedVarClause'][0];
		...
		if(!is_null($estVariationClause)){
			//means variation hasn't occurred
			$currentDeedVarClause = $estVariationClause;
			$currentDeedDate = $fundEstDate;
			$to = 'tim@justsuper.com.au';
				 $subject = 'Establishment Deed Varition Clause & Date';
				 $message = 'Current Deed Var Clause is the Establishment Deed Var Clause: '.$estVariationClause.' '.$currentDeedVarClause;
			...
			$to = 'tim@justsuper.com.au';
				 $subject = 'Deed Varition Clause & Date';
				 $message = 'Current Deed Var Clause is NOT the Establishment Deed Var Clause: '.$currentDeedVarClause;
				 wp_mail( $to, $subject, $message);
		}
