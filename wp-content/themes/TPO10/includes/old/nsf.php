...
function nsf_and_corp_post_data($item, $order_id, $deedVersion, $constitutionVersion, $billingArray, $billingName, $billingCompany, $billing_phone, $product_id, $adviserEmail, $userID, $orderDate) {
		...
		$m1details = array(	
			...
			'memberDOB' => $m1dob,
			'memberGender' => NULL,
			'memberTownOfBirth' => $item['item_meta']['m1CityOfBirth'][0],
			'memberStateOfBirth' => $item['item_meta']['m1StateOfBirth'][0],
			'memberCountryOfBirth' => $item['item_meta']['m1CountryOfBirth'][0],
			'memberOccupation' => NULL,
			'isCompany' => NULL,
			'companyname' => NULL,
			'hasacn' => NULL,
		...
		$m2details = array(
			...
			'memberDOB' => $m2dob,
			'memberGender' => NULL,
			'memberTownOfBirth' => $item['item_meta']['m2CityOfBirth'][0],
			'memberStateOfBirth' => $item['item_meta']['m2StateOfBirth'][0],
			'memberCountryOfBirth' => $item['item_meta']['m2CountryOfBirth'][0],
			'memberOccupation' => NULL,
			'isCompany' => NULL,
			'companyname' => NULL,
			'hasacn' => NULL,
		...
		$m3details = array(
			...
			'memberDOB' => $m3dob,
			'memberGender' => NULL,
			'memberTownOfBirth' => $item['item_meta']['m3CityOfBirth'][0],
			'memberStateOfBirth' => $item['item_meta']['m3StateOfBirth'][0],
			'memberCountryOfBirth' => $item['item_meta']['m3CountryOfBirth'][0],
			'memberOccupation' => NULL,
			'isCompany' => NULL,
			'companyname' => NULL,
			'hasacn' => NULL,
		...
		$m4details = array(
			...
			'memberDOB' => $m4dob,
			'memberGender' => NULL,
			'memberTownOfBirth' => $item['item_meta']['m4CityOfBirth'][0],
			'memberStateOfBirth' => $item['item_meta']['m4StateOfBirth'][0],
			'memberCountryOfBirth' => $item['item_meta']['m4CountryOfBirth'][0],
			'memberOccupation' => NULL,
			'isCompany' => NULL,
			'companyname' => NULL,
			'hasacn' => NULL,
		...
		$nonMemberDirectorDetails = array(
			...
			'memberGender' => NULL,
			'memberTownOfBirth' => $item['item_meta']['d2NonMemberCityOfBirth'][0],
			'memberStateOfBirth' => $item['item_meta']['d2NonMemberStateOfBirth'][0],
			'memberCountryOfBirth' => $item['item_meta']['d2NonMemberCountryOfBirth'][0],
			'memberOccupation' => NULL,
			'isCompany' => NULL,
			'companyname' => NULL,
			'hasacn' => NULL,
