                          ...
                          <ul class="dropdown-menu multi-level" style="min-width: 107px;">
                            <li class="dropdown-submenu">
                                ...
                                <ul class="dropdown-menu" style="min-width: 107px;">
                                    ...
                                    <li><a href="https://app.thesmsfacademy.com.au/?gf_pdf=1&fid='.$lead->form_id.'&lid='.$lead->id.'&download=1&template='.$gfpdf->get_template($lead->form_id).'" class="dropbox-saver action-dropbox-options"></a></li>
                                    <li>
            ...
            elseif(($lead->form_id == "52") OR ($lead->form_id == "6")){
                ...
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu" style="min-width: 107px;">
                    ...
                    <li><a href="https://app.thesmsfacademy.com.au/?gf_pdf=1&fid='.$lead->form_id.'&lid='.$lead->id.'&download=1&template='.$gfpdf->get_template($lead->form_id).'"> Trustee Declarations</a></li>
                     ...
                     <li>
                        <div class="action-google-drive-options" >
                            <div
                                ...
                                data-src="https://app.thesmsfacademy.com.au/?gf_pdf=1&fid='.$lead->form_id.'&lid='.$lead->id.'&download=1&template='.$gfpdf->get_template($lead->form_id).'">
...
//
                ...
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu" style="min-width: 107px;">
                    ...
                    <li>
                       ...
                       <a 
                            href="https://app.thesmsfacademy.com.au/wp-content/uploads/PDF_EXTENDED_TEMPLATES/output/151073/abp_resolutions.pdf"
                            class="dropbox-saver action-dropbox-options" 
                            data-filename="'.$lead->form_id.$lead->id.'.jpg" >
                        </a> 
                     </li>
                     <li>
                        <div class="action-google-drive-options" >
            ...
            elseif(($lead->form_id != "66") && ($lead->form_id != "71") && ($lead->form_id != "68")) {
                $output .= '<tr><td>'.$lead->form_id.$lead->id.'</td><td>'.get_reference($lead->form_id, $lead->id, $wpdb).'</td><td>'.get_name($lead->form_id, $lead->id, $wpdb).'</td><td>'.$lead->title.'</td><td>'.date("d/m/Y", strtotime($lead->date_created)).'</td><td>'.$lead->orderStatus.'</td><td>
                <div class="btn-group">
                  <a class="btn-xs btn-primary " style="float: left; background-color: #4b8df8;" href="#"><i class="fa fa-download fa-fw"></i> Actions</a>
                  <a class="btn-xs btn-primary  dropdown-toggle" style="float: left; background-color: #4b8df8;" data-toggle="dropdown" href="#">
